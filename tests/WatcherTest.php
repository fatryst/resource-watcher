...
class WatcherTest extends PHPUnit_Framework_TestCase {
	...
	public function testWatchDirectoryResource()
	{
		...
		$this->assertInstanceOf('Fatryst\ResourceWatcher\Resource\DirectoryResource', $resource[0]);
	}
	...
	public function testWatchFileResource()
	{
		...
		$tracked = $this->watcher->getTracker()->getTracked();
		$resource = array_pop($tracked);
		$this->assertInstanceOf('Fatryst\ResourceWatcher\Resource\FileResource', $resource[0]);
	}
	...
	{
		$this->assertInstanceOf('Fatryst\ResourceWatcher\Tracker', $this->watcher->getTracker());
	}
	...
	public function testTrackingsAreChecked()
	{
		...
		$this->assertInstanceOf('Fatryst\ResourceWatcher\Listener', $listener);
